...
for run in range(N_RUNS):
    ...
    display_predictions(convert_to_color(train_gt), viz, caption="Train ground truth")##注释可视化
    display_predictions(convert_to_color(test_gt), viz, caption="Test ground truth")##注释可视化
